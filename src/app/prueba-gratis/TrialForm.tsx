      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            <label
              htmlFor="logo-input"
              className="cursor-pointer bg-[var(--color-crema)] border border-[var(--color-gris)] text-white text-sm font-semibold px-4 py-2 rounded-lg hover:opacity-80 transition-opacity whitespace-nowrap"
            >
              Elegir archivo
            </label>
            <input
