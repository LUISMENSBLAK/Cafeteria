...
class BluetoothPrinterManager(
    ...
    fun requestPermission(): Boolean {
        ...
        lastError = if (granted) "" else "Falta el permiso BLUETOOTH_CONNECT. Concédelo en Configuración → Aplicaciones → Abaroa POS → Permisos."
    ...
    companion object {
        private const val TAG = "AbaroaBtPrinter"
        private const val PREFERENCES = "abaroa_bluetooth_printer"
