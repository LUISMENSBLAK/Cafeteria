package com.innovanetwork.abaroapos
...
import com.innovanetwork.abaroapos.printing.AndroidBluetoothPrinterBridge
import com.innovanetwork.abaroapos.printing.AndroidPrinterBridge
import com.innovanetwork.abaroapos.printing.BluetoothPrinterManager
import com.innovanetwork.abaroapos.printing.UsbEscPosPrinterManager
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!BuildConfig.DEBUG && trustedUri.scheme != "https") {
            showError("Configuración insegura", "La URL de producción de Abaroa POS debe utilizar HTTPS.")
            return
        }
    ...
    private fun configureWebView() {
        ...
        webView.settings.apply {
            ...
            userAgentString = "$userAgentString AbaroaPOSAndroid/${BuildConfig.VERSION_NAME}"
        }
            ...
            override fun onReceivedHttpError(
                ...
                if (request?.isForMainFrame == true && (errorResponse?.statusCode ?: 0) >= 500) {
                    showError(
                        ...
                        "Abaroa POS devolvió el error HTTP ${errorResponse?.statusCode}. Pulsa Reintentar.",
                    )
                }
            }
